...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_DT_HAS_ST_HCI_SPI_V1_ENABLED, 1);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_BOARD_DISCO_L475_IOT1_STM32L475XX, 1);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_SHELL_TX_TIMEOUT_MS, 50);
